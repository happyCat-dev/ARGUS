...
[История версий](CHANGELOG.md) · [Контекст для разработки](CLAUDE.md) · [Лицензия и происхождение](NOTICE.md)
...
```shell
wget -f https://raw.githubusercontent.com/happyCat-dev/ARGUS/v2.5.1/setup.lua && setup
```
...
setup --branch=v2.5.1                  # конкретный тег
