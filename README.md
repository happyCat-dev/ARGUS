...
```shell
cd /home
wget -f https://cdn.jsdelivr.net/gh/sblndn20/ARGUS@v2.3.2/setup.lua && setup
```
...
```shell
wget -f https://raw.githubusercontent.com/sblndn20/ARGUS/v2.3.2/setup.lua && setup
```
...
setup --branch=v2.3.2                  # конкретный тег
